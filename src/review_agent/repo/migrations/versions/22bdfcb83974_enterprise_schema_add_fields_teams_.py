...
def upgrade() -> None:
    ...
    op.add_column(
        "commits", sa.Column("additions", sa.Integer(), nullable=False, server_default=sa.text("0"))
    )
    op.add_column(
        "commits", sa.Column("deletions", sa.Integer(), nullable=False, server_default=sa.text("0"))
    )
    op.add_column(
        "commits",
    ...
    op.add_column(
        "projects", sa.Column("settings", sa.Text(), nullable=False, server_default=sa.text("'{}'"))
    )
    op.create_foreign_key(None, "projects", "users", ["owner_id"], ["id"])
    op.add_column(
        "reviews",
        sa.Column(
            "trigger_type", sa.String(length=32), nullable=False, server_default=sa.text("'manual'")
        ),
    )
    ...
    op.add_column(
        "reviews",
        sa.Column("commits_count", sa.Integer(), nullable=False, server_default=sa.text("0")),
    )
    op.add_column("reviews", sa.Column("branch", sa.String(length=255), nullable=True))
    op.add_column(
        "users",
        sa.Column(
            "password_hash", sa.String(length=255), nullable=False, server_default=sa.text("''")
        ),
    )
    op.add_column(
        "users",
        sa.Column(
            "display_name", sa.String(length=255), nullable=False, server_default=sa.text("''")
        ),
    )
    ...
    op.add_column(
        "webhook_events",
        sa.Column(
            "repo_full_name", sa.String(length=512), nullable=False, server_default=sa.text("''")
        ),
    )
